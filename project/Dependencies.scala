...
object Dependencies {
  ...
  val munit = Def.setting("org.scalameta" %%% "munit" % "1.3.0" % Test)
  val munitCatsEffect = Def.setting("org.typelevel" %%% "munit-cats-effect" % "2.2.0" % Test)
  ...
  val scalaCheckEffect = Def.setting("org.typelevel" %%% "scalacheck-effect" % "2.1.0" % Test)
